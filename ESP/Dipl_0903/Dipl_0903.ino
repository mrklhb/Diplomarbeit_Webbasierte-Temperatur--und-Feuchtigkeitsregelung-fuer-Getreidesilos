...
.content {
    padding: 20px;
    text-align: center; /* Zentriert den Text und inline-Elemente innerhalb von .content */
  }
...
.button2 {
 ...
 canvas {
    min-width: 500px;
    min-height: 300px;
    display: block; /* Behandelt das Canvas-Element als Block-Element */
    margin: 20px auto; /* Fügt oberen und unteren Abstand hinzu und zentriert es horizontal */
  }
